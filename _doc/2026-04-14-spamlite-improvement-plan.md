...
- **thenutfarm is the opposite outlier** (2243/11222, fn=2 fp=15). Somebody trained it aggressively on spam at some point. Accounts for 15/30 cluster-wide fp alone.
...
3. **Apply threshold=0.75 to thenutfarm immediately.** Zero-risk operational fix. Plausibly halves cluster-wide fp count in tomorrow's digest.
